...
const AdminApplications = () => {
  ...
  const getAllApp = async (e) => {
    try {
      ...
      const temp = await fetchData(`https://health-otpr.onrender.com/api/doctor/getnotdoctors`);
  ...
  const acceptUser = async (userId) => {
    try {
      ...
      if (confirm) {
        await toast.promise(
          axios.put(
            "https://health-otpr.onrender.com/api/doctor/acceptdoctor",
            { id: userId },
            {
              headers: {
  ...
  const deleteUser = async (userId) => {
    try {
      ...
      if (confirm) {
        await toast.promise(
          axios.put(
            "https://health-otpr.onrender.com/api/doctor/rejectdoctor",
            { id: userId },
            {
              headers: {
                authorization: `Bearer ${localStorage.getItem("token")}`,
